...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('posts')->group(function () {
        Route::get('/', [PostController::class, 'index'])->middleware('can:viewAny,App\Post')->name('posts.index');
        Route::get('/create', [PostController::class, 'create'])->middleware('can:create,App\Post')->name('posts.create');
        Route::post('/', [PostController::class, 'store'])->middleware('can:create,App\Post')->name('posts.store');
        Route::get('/{post}', [PostController::class, 'show'])->middleware('can:view,post')->name('posts.show');
        Route::get('/{post}/edit', [PostController::class, 'edit'])->middleware('can:update,post')->name('posts.edit');
